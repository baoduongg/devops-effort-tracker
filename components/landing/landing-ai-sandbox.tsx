    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
        ...
        <motion.div
          ...
          className="lg:col-span-6 p-6 sm:p-7 rounded-3xl bg-white/[0.02] border border-white/[0.08] hover:border-white/[0.15] transition-colors flex flex-col justify-between"
        >
          <div>
            <div className="text-xs sm:text-sm font-bold text-sky-400 uppercase tracking-wider mb-2.5 flex items-center gap-2">
              <Terminal size={16} />
            ...
            <div className="relative">
              <textarea
                ...
                className="w-full text-sm sm:text-base p-4 pr-14 rounded-2xl bg-black/50 border border-white/[0.12] text-white focus:outline-none focus:border-sky-500/50 resize-none font-mono transition-colors"
              />
              <motion.button
        ...
        <motion.div
          ...
          className="lg:col-span-6 p-6 sm:p-7 rounded-3xl bg-black/60 border border-white/[0.08] hover:border-white/[0.15] transition-colors flex flex-col justify-center min-h-[320px] relative overflow-hidden"
        >
