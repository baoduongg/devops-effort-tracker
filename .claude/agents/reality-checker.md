...
description: Performs a final, skeptical pre-release verification pass, defaulting to 'NEEDS WORK' unless there is overwhelming evidence a feature is actually production-ready. Auto-invoke as the last gate before declaring work done or shippable, after review and testing have already passed.
