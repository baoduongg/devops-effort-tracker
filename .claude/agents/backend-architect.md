...
description: Designs and implements server-side systems: APIs, database schemas, service boundaries, and cloud infrastructure for scale and reliability. Auto-invoke for any task that adds or modifies backend routes, data models, or infra-facing code.
