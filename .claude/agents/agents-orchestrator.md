...
description: Coordinates the full multi-agent dev pipeline end to end, sequencing specialist agents from spec through implementation, review, testing, and deploy prep. Auto-invoke when a feature request spans multiple roles and needs orchestration rather than a single fix.
