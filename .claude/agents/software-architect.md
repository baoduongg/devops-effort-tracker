...
description: Designs system structure, module boundaries, data flow, and architectural trade-offs before code is written. Auto-invoke after a spec exists and before frontend/backend implementation begins, or when a change touches multiple modules/services.
