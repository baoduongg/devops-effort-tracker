...
description: Automates infrastructure, CI/CD pipelines, and cloud/deploy operations. Auto-invoke when preparing a feature for deployment, editing CI config, or setting up infrastructure automation.
